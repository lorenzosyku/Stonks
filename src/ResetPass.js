    ...
    <div className="min-h-screen flex justify-center items-center">
      <form className="md:flex flex-col shadow-lg rounded-md py-5 w-1/4">
        <div className="bg-shade-lightblue h-[60px]">
          <h2 className="p-3 text-xl text-gray-100 font-semibold">Reset Password</h2>
        </div>
        ...
        <div className="p-5 text-gray-500 text-sm">
          <p>
            Once you type in your Email here and click the "Send link" button, you will be sent a password reset
            link. Please check your <span className="font-bold">inbox</span>{" "}
            shortly.
          </p>
        </div>
        <div className="flex justify-start items-center px-5">
          <span className="text-blue-500 cursor-pointer hover:underline">Back to Login</span>
        </div>
